# Cycling Coach V0.7.2 安装指南

> **无桌面安装包**: V0.7.2 桌面应用仍暂停 (V0.5.3 闪退, 暂用 dev 模式 + 浏览器)
> **本文教你用 dev 模式跑 V0.7.2**: 双击 `tools\start.bat` → 浏览器开 `http://localhost:1420`
...
tools\start.bat         :: 启动 V0.7.2
```

## 方案 B: 全新安装 (无 git)

1. 下载这 2 个 zip:
   - `cycling-coach-v0.7.2-source.zip` (5.1 MB) — 源码
   - `cycling-coach-v0.7.2-kb.zip` (156 MB) — 训练百科 (受限许可)
...
3. 复制 kb zip **进** source 目录, 解压覆盖 `kb_source/`:
   ...
   :: 把 cycling-coach-v0.7.2-kb.zip 放当前目录
