# Cycling Coach V0.7.5.9 安装指南

> **无桌面安装包**: V0.7.5.9 桌面应用仍暂停 (V0.5.3 闪退, 暂用 dev 模式 + 浏览器)
> **本文教你用 dev 模式跑 V0.7.5.9**: 双击 `tools\start.bat` → 浏览器开 `http://localhost:1420`
